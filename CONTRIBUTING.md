...
You are here to help on `Build-Bonita` repo? Awesome, feel welcome and read the following guidelines in order to know how to contribute, to ask questions and to improve `Build-Bonita` quality for the benefit of our entire community.
...
- help people with the questions they ask on the [Github Issues](https://github.com/Bonitasoft-Community/Build-Bonita/issues)
- submitting bug reports and feature requests in the [Github Issues](https://github.com/Bonitasoft-Community/Build-Bonita/issues/new)
- [writing code](CONTRIBUTING.md#code-and-documentation-changes-guidelines) which can be incorporated into `Build-Bonita` itself
